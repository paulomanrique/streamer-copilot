import type { TwitchConnectionStatus } from '../../shared/types.js';
...
export function StatusBar({ activeProfileName, obsConnected, twitchStatus, twitchChannel }: StatusBarProps) {
