...
.chat-message.linkedin { border-left-color: rgba(10, 102, 194, 0.35); }
...
.platform-badge.linkedin { background: var(--linkedin); color: var(--linkedin-text); }
