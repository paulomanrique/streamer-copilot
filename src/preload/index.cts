...
const copilotApi: CopilotApi = {
  ...
  youtubeApiGetCredentialsStatus: () => ipcRenderer.invoke(IPC_CHANNELS.youtubeApiGetCredentialsStatus) as Promise<any>,
  youtubeApiSetCredentials: (input) => ipcRenderer.invoke(IPC_CHANNELS.youtubeApiSetCredentials, input) as Promise<any>,
  youtubeApiClearCredentials: () => ipcRenderer.invoke(IPC_CHANNELS.youtubeApiClearCredentials) as Promise<any>,
  youtubeApiStartOAuth: (input) => ipcRenderer.invoke(IPC_CHANNELS.youtubeApiStartOAuth, input) as Promise<any>,
  youtubeApiDisconnectChannel: (input) => ipcRenderer.invoke(IPC_CHANNELS.youtubeApiDisconnectChannel, input),
